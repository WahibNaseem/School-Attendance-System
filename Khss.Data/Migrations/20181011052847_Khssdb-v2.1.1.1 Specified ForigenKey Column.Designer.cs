...
namespace KhssData.Migrations
{
    ...
    [Migration("20181011052847_Khssdb-v2.1.1.1 Specified ForigenKey Column")]
    partial class Khssdbv2111SpecifiedForigenKeyColumn
    {
            ...
            modelBuilder.Entity("KhssData.DomainModels.Attendance.Attendance", b =>
                {
                    ...
                    b.Property<int?>("StudentClassesRefId");

                    b.HasKey("AttendanceId");

                    b.HasIndex("StudentClassesRefId");
            ...
            modelBuilder.Entity("KhssData.DomainModels.Attendance.Attendance", b =>
                {
                    b.HasOne("KhssData.DomainModels.Attendance.StudentClass", "StudentClass")
                        ...
                        .HasForeignKey("StudentClassesRefId");
                });
